	...
	<main>
		<div class="col-sm-10">
			<div class="container-sm mt-4 mb-4 border">
				...
				<form class="form-horizontal" action="<?php echo base_url('index.php/PasienC/form_pasien/');?>" method="POST">
					<div class="form-group">
						<div class="col-md-12">
							<select style="width:1020px" type="jenisKelamin" class="dropdown" id="jk" name="gender">
